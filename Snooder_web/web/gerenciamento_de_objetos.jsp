<%-- 
    Document   : gerenciamento_de_objetos
    Created on : 28/09/2015, 22:45:34
...
<body>
  ...
  -->
	...
	<center><h3>Gerenciamento de Objetos</h3></center>
  <div class="well" style="margin: 3% 30%">
	<form>
		
	
    	<div class="form-group">
    	<button type="submit" class="btn btn-default">Cadastrar Novo Objeto</button><br/><br/>

		<table class="table table-bordered table-striped">
        <tr>
          <td class="h4 col-md-2">Nome</td>
          <td class="h4 col-md-4">Descrição</td>
          <td class="h4 col-md-4">Status</td>
		  <td class="h4 col-md-4">Alterar</td>
		  <td class="h4 col-md-4">Apagar</td>
        </tr>
        <tr>
          <td class="col-md-2">teste</td>
          <td class="col-md-4">teste</td>
          <td class="col-md-4">teste</td>
		  <td class="col-md-4"><input type = "radio"/></td>
          <td class="col-md-4"><input type = "radio"/></td>
        </tr>
        <tr>
          <td class="col-md-2">teste</td>
