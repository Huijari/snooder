<%-- 
    Document   : cadastro_objeto_perdido
    Created on : 28/09/2015, 22:37:29
...
<body>
  ...
  <div class="well" style="margin: 3% 30%">
    <form>
      ...
      <div class="form-group">
        <label for="local">Local onde o objeto foi perdido:</label>
        <input type="local" class="form-control" id="local" placeholder="Local perdido">
      </div>
      <div class="form-group">
