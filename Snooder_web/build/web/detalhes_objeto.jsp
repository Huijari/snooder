<%-- 
    Document   : detalhes_objeto
    Created on : 28/09/2015, 22:25:17
...
<body>
  ...
  -->
	...
	<center><h3>Detalhes do Objeto</h3></center>
  <div class="well" style="margin: 3% 30%">
	<form>
		...
		<div class="form-group">
    	<label for="sobrenome">Local na instituição: TESTE</label>
  	...
  	<div class="form-group">
		...
		<label>
			<br>testetestetestetestetestetesteteste</br>
			testetestetestetestetestetesteteste</br>
			testetestetestetestetestetesteteste</br>
			testetestetestetestetestetesteteste</br>
			testetestetestetestetestetesteteste</br>
			testetestetestetestetestetesteteste</br>
  	...
  	<div class="form-group">
    	<label for="senha">Categoria: TESTE</label>
