<%-- 
    Document   : registro
    Created on : 28/09/2015, 22:47:17
...
<body>
  ...
  <div class="well" style="margin: 3% 30%">
	<form>
    	...
    	<input type="text" class="form-control" id="nome" placeholder="Nome" width="10%" size="12">
		
		</div>  
		<div class="form-group">
    	<label for="sobrenome">Digite o Sobrenome</label>
    	<input type="text" class="form-control" id="sobrenome" placeholder="Sobrenome" size="14">
	</div>   
  	<div class="form-group">
  	...
  	<div class="text-center"><button type="submit" class="btn btn-default">Registrar</button></div>
	</form>
  </div>
