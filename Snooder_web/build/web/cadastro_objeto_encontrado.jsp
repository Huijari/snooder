<%-- 
    Document   : cadastro_objeto_encontrado
    Created on : 28/09/2015, 22:48:05
...
<body>
  ...
  <div class="well" style="margin: 3% 30%">
	<form>
    	...
    	<input type="text" class="form-control" id="nome" placeholder="Nome" width="10%" >
		...
		<div class="form-group">
    	<label for="sobrenome">Local onde foi encontrado</label>
