<%-- 
    Document   : edição_objeto
    Created on : 28/09/2015, 22:39:43
...
<body>
  ...
  <div class="well" style="margin: 3% 30%">
    <form>
	<center><h3>Editar Objeto</h3></center>
      <div class="form-group">
	  ...
	  <div class="text-center"><button type="submit" class="btn btn-default">Salvar Alterações</button></div>
	</form>
    </form>
  </div>
