<%-- 
    Document   : home
    Created on : 28/09/2015, 22:54:03
...
<body>
  ...
  <img src="img/Img_01.png" class="img-responsive center-block" alt="Responsive image" width="100%" style="margin: 0px">

  <p class="h1 text-center"><strong>RECENTES</strong></p>

  <div style="margin: 5% 8%" id="encontrados">
    <p class="h2 text-center">Encontrados</p>
    <div class="table-responsive">
      <table class="table table-bordered table-striped">
        <tr>
          <td class="h4 col-md-2">Nome</td>
          <td class="h4 col-md-4">Descrição</td>
          <td class="h4 col-md-4">Local encontrado</td>
        </tr>
        <tr>
          <td class="col-md-2">teste</td>
          <td class="col-md-4">teste</td>
          <td class="col-md-4">teste</td>
        </tr>
        <tr>
          <td class="col-md-2">teste</td>
    ...
    <p class="text-right"><a href="encontrados.html">Mostrar todos</a></p>
  </div>

  <div id="perdidos" style="margin: 5% 8%">
    <p class="h2 text-center">Perdidos</p>
    <div class="table-responsive" style="">
      <table class="table table-bordered table-striped">
        <tr>
          <td class="h4 col-md-2">Nome</td>
          <td class="h4 col-md-4">Descrição</td>
          <td class="h4 col-md-4">Local perdido</td>
        </tr>
        <tr>
          <td class="col-md-2">teste</td>
          <td class="col-md-4">teste</td>
    ...
    <p class="text-right"><a href="perdidos.html">Mostrar todos</a></p>
  </div>
